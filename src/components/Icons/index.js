...
export const TickBlue = ({ fontSize = '14px', className }) => (
    <svg
        className={className}
        fontSize="14px"
        viewBox="0 0 48 48"
...
export const Persion = ({ width = '20px', height = '20px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const Coin = ({ width = '20px', height = '20px', className }) => (
    <svg 
        className={className} 
        width={width} 
        height={height} 
...
export const Setting = ({ width = '20px', height = '20px', className }) => (
    <svg 
        className={className} 
        width={width} 
        height={height} 
...
export const Language = ({ width = '20px', height = '20px', className }) => (
    <svg 
        className={className}
        width={width} 
        height={height} 
...
export const Question = ({ width = '20px', height = '20px', className }) => (
    <svg 
        className={className}
        width={width}
        height={height}
...
export const Keyboard = ({ width = '20px', height = '20px', className }) => (
    <svg 
        className={className} 
        width={width}  
        height={height} 
...
export const Logout = ({ width = '20px', height = '20px', className }) => (
    <svg 
    className={className} 
        width={width}  
        height={height} 
